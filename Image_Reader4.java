...
public class Image_Reader4 {
	...
	*/
	...
	/*public static int[] range(int x, int y, Rune4 newRune) {
	...
	public static void main(String[] args) {
		...
		Point2D startingPixel = startingPixel(Point1, newRune);
		x = (int) startingPixel.getX();
		y = (int) startingPixel.getY();
		
		System.out.printf("The starting pixel for this is %d,%d\n", x, y);

		DamageAlgorithm damage = new DamageAlgorithm(startingPixel,newRune);
		Point2D damagePixel = damage.theAlgorithm();
		x = (int) damagePixel.getX();
		y = (int) damagePixel.getY();
